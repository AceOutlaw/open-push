...
function remote_probe(manufacturer, model, prober)
    ...
    local port_name = "OpenPush Transport"
    local request = "f0 00 11 22 01 70 f7"
    local response = "f0 00 11 22 01 71 ?? f7"
...
function remote_prepare_for_use()
    ...
    local hello_sysex = "f0 00 11 22 01 72 f7"  -- 0x72 = connected notification
